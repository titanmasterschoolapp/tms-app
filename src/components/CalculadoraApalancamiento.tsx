...
export default function CalculadoraApalancamiento() {
  ...
  return (
    <div id="calc-apalan-container" className="p-6 bg-zinc-900/40 border border-zinc-800/80 rounded-2xl backdrop-blur-md">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-2.5 rounded-xl bg-pink-500/10 border border-pink-500/30 text-pink-400">
          <Calculator className="w-5 h-5" />
        </div>
        <div>
          <h3 className="font-sans font-semibold text-lg text-white">Calculadora de apalancamiento y futuros</h3>
