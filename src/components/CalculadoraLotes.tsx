...
import { Percent, Wallet, ArrowRight, ShieldAlert, FileSliders } from 'lucide-react';
...
export default function CalculadoraLotes() {
  ...
  return (
    <div id="calc-lotes-container" className="p-6 bg-zinc-900/40 border border-zinc-800/80 rounded-2xl backdrop-blur-md">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-sans font-semibold text-lg text-white">Calculadora de lotes</h3>
